...
- [x] **[ux]** Toast notification system for user actions
  - Completed: 2026-01-01
  - Files: `web/contexts/ToastContext.tsx`, `web/components/ui/Toast.tsx`, `web/App.tsx`, `web/pages/GroupDetails.tsx`
  - Impact: Replaced intrusive alerts with modern toast notifications
